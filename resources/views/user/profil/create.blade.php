        ...
        <div class="card-body">
            <div class="container">
                <form action="{{ route('profil.store',Auth::user()->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <img src="" id="foto-preview" class="mx-auto" style="display: none; margin-bottom: 10px; max-width: 200px; border-radius:100%" alt="Preview Foto">
                    ...
                    <script>
                        const inputFoto = document.querySelector('input[name="avatar"]');
