    ...
    <div class="container">
        <div class="card mb-3 col-md-8 mx-auto mt-5 shadow-lg" style="background-color:#f0fdf4">
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <button type="submit" class="btn btn-light mb-4 rounded-pill form-control" style="background-color:#4ade80">Masuk</button>
                            <div class="text-center">
                                <p class="fs-6">
                                    Belum punya akun?
                                    @if (Route::has('register'))
                                    <a class="text-primary fw-bold" href="{{ route('register') }}">Daftar disini</a>
                                    @endif
                                </p>
                            </div>
                        </form>
                ...
                <div class="col-md-6">
                    <img src="{{'image/Sign in.png'}}" class="img-fluid rounded-end-5  d-md-block" alt="...">
                </div>
            </div>
        </div>
